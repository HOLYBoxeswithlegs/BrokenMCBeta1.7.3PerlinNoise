...
public class NoiseGeneratorPerlin extends NoiseGenerator {
    ...
    static class NoiseParams {
        ...
        NoiseParams() {
            offset = 0.0f;
            scale = 0.5f; // Reduced amplitude for smoother terrain
            spread = new Vector3(600.0f, 600.0f, 300.0f); // Increased Z spread for smoother vertical transitions
            seed = 0;
            octaves = 3;
            persist = 0.6f;
            lacunarity = 2.0f;
    ...
    public void func_805_a(double[] var1, double var2, double var4, double var6, int var8, int var9, int var10,
        ...
        if (var9 == 1) {
            ...
            for (int i = 0; i < var8 * var10; i++) {
                var1[i] += result[i] * 32.0 / var17; // Adjusted scaling for smoother terrain
            }
        } else {
